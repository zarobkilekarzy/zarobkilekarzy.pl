...
1. utworzenia jawnego, ogólnodostępnego rejestru, który dla każdej osoby wykonującej zawód lekarza i lekarza dentysty — identyfikowanej jawnym numerem prawa wykonywania zawodu (PWZ) — wykazuje łączną roczną kwotę brutto otrzymaną ze środków publicznych (Narodowy Fundusz Zdrowia, budżet państwa, publiczne podmioty lecznicze, uczelnie medyczne);

2. wykazywania tej kwoty w rozbiciu na poszczególne strumienie — podmiot wypłacający, formę współpracy (umowa o pracę, kontrakt, umowa cywilnoprawna), tytuł wypłaty (świadczenia, dyżur, gotowość, funkcja) oraz odpowiadający im wymiar godzin — tak, aby widoczna była zarówno suma, jak i jej struktura; przy formach typu B2B rejestr wykazuje przychód brutto przed kosztami i podatkami, odzwierciedlając wydatek publiczny, a nie dochód osobisty;
...
UZASADNIENIE
Środki publiczne podlegają jawności — obywatel ma prawo wiedzieć, jak wydawany jest pieniądz, który wpłaca. W ochronie zdrowia dzieje się to wybiórczo: jawne są ustawowe stawki na etacie i płace kadry kierowniczej, ale ile jedna osoba otrzymuje łącznie z kontraktów — ze wszystkich publicznych źródeł i tytułów — nie wiadomo. Nie sumuje tego ani NFZ, ani AOTMiT (tylko dane zbiorcze placówek); rejestry umów i wniosek o informację publiczną sięgają najwyżej jednego kontraktu lub placówki. Przy budżecie NFZ ponad 200 miliardów złotych to realna luka w kontroli wydatków publicznych.

Sama suma jednak nie wystarczy — dopiero rozbicie na podmiot, formę i wymiar godzin poddaje ten wydatek realnej kontroli, ujawniając choćby godziny rozliczane w kilku miejscach naraz lub przekraczające liczbę godzin w roku. Dlatego rejestr musi być jawny, zsumowany per osoba i przeszukiwalny. Rejestr obejmuje lekarzy, bo to u nich publiczny pieniądz najczęściej rozprasza się na wiele równoległych kontraktów w różnych podmiotach — i tam najtrudniej złożyć jego sumę. Na przejrzystości pieniądza publicznego zyskują pacjenci i samo środowisko lekarskie, któremu jawność daje jasne reguły zamiast zbiorowego podejrzenia.
